...
35. [x] ปิด Auto-reply ถ้าไม่ต้องการให้ OA ตอบซ้อนกับระบบ - updated 2026-07-10
36. [x] กด Verify webhook URL - updated 2026-07-10
37. [x] เพิ่ม OA เข้ากลุ่ม LINE - updated 2026-07-10
38. [x] ส่ง `@ชื่อOA เริ่มเก็บข้อมูล` - updated 2026-07-10
39. [x] ส่งข้อความทั่วไป แล้วตรวจ `line_chat_messages` - updated 2026-07-10
40. [x] ส่ง `@ชื่อOA หยุดเก็บข้อมูล` - updated 2026-07-10
41. [x] ส่งข้อความต่อ แล้วตรวจว่าไม่มีข้อความใหม่ถูกบันทึก - updated 2026-07-10
42. [x] รัน worker ใน environment จริงด้วย `php artisan queue:work` - updated 2026-07-10
