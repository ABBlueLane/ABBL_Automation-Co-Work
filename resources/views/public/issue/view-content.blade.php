<div class="col-lg-12">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <hr class="mt-2 mb-4">
            <div class="mb-4">
                {!! nl2br(e(optional($issue->firstComment)->comment ?? '-')) !!}
            </div>
            @if ($issue->url)
                <div class="mb-4">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div>
                        {{ optional($issue->creator)->full_name ?? '-' }}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        {{ optional($issue->assignee)->full_name ?? '-' }}
                    </div>
                </div>
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <div>
                        {!! method_exists($issue, 'getPriorityBadgeHtml') ? $issue->getPriorityBadgeHtml() : '-' !!}
                    </div>
                </div>
            </div>
            @php
